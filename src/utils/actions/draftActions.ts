...
>;
type PublishDraft = (
  post: Omit<DraftPost, "id" | "createdAt" | "updatedAt">
) => Promise<
  "Insufficient details" | "User not Exist" | "Server Error" | "Successful"
>;
type DeleteDraft = (
  id: string
) => Promise<"Insufficient details" | "Server Error" | "Successful">;
type ModifyResponse = (
  post: Omit<DraftPost, "createdAt" | "updatedAt" | "userEmail" | "slug">
) => Promise<
  "Insufficient Details" | "User not Exist" | "Server Error" | "Success"
>;
