    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-3">
                ...
                <div className="space-y-2">
                    <Label className={cn('pl-2 text-base font-medium', errors?.password && 'text-red-600')} htmlFor="password">
                        Password <span className="text-red-600">*</span>
                    </Label>
                    <div className="w-full relative flex items-center">
                        <Input {...register('password')} placeholder="Enter you password" type={showPassword ? 'text' : 'password'} className="tracking-wider " />
                        {!showPassword ? (
